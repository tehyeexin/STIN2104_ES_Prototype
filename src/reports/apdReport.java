...
public class apdReport extends JFrame {
	...
	public apdReport() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(apdReport.class.getResource("/images/icon.png")));
		...
		txtrReport.setText("\t\tPatient's Information"
				...
				+ "\r\n-----------------------------------------------------------------------------------------------------------"
				+ "\r\n\t\t  Diagnostic Result"
				+ "\r\n\nPatient's psychological disorder: Antisocial Personality Disorder (APD)"
				+ "\r\nTreatments: Psychotherapy, Medication, Democratic therapeutic communities (DTC)\r\n");

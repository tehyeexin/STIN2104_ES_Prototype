...
public class schizophreniaResult extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					schizophreniaResult frame = new schizophreniaResult();
	 ...
	 * Create the frame.
	 */
	public schizophreniaResult() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setTitle("Psychological Disorders Diagnosis Expert System");
		setIconImage(Toolkit.getDefaultToolkit().getImage(schizophreniaResult.class.getResource("/images/icon.png")));
		...
		JLabel lblDisorder = new JLabel("Schizophrenia");
		lblDisorder.setFont(new Font("Yu Gothic UI", Font.BOLD, 35));
		lblDisorder.setHorizontalAlignment(SwingConstants.CENTER);
		lblDisorder.setBounds(104, 50, 231, 50);
		...
		txtrExplain.setText("Schizophrenia is a severe mental disorder in which \r\npeople have disorganized speech, abnormal \r\nbehavior, and an inability to understand reality.");
		...
		btnHow.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "The system diagnoses your psychological disorder based on the following symptoms:\n" 
													+ symptoms.schizophreniaSymptoms.symptomsList
													+"\n\nThese are the symptoms that constitute Schizophrenia.");
			}
		});
		...
		btnTreatment.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				treatments.schizophreniaTreatments frame = new treatments.schizophreniaTreatments();

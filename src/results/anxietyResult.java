...
import reports.schizophreniaReport;
import symptoms.anxietySymptoms;
...
public class anxietyResult extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					anxietyResult frame = new anxietyResult();
	...
	public anxietyResult() {
		...
		txtrExplain.setText("Anxiety is an emotional disorder characterized \r\nby nervousness, fear, irritability, and worrying \r\nthoughts under the action of neurological factors,\r\naccompanied by obvious physical symptoms.");
		...
		btnTreatment.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				treatments.anxietyTreatments frame = new treatments.anxietyTreatments();

...
public class ocdResult extends JFrame {
	...
	public ocdResult() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ocdResult.class.getResource("/images/icon.png")));
		...
		JLabel lblDisorder = new JLabel("Obsessive-Compulsive Disorder");
		lblDisorder.setFont(new Font("Yu Gothic UI", Font.BOLD, 27));
		lblDisorder.setHorizontalAlignment(SwingConstants.CENTER);
		lblDisorder.setBounds(15, 50, 397, 50);
		...
		txtrExplain.setText("Obsessive-compulsive disorder is when you are \r\nthought-driven to perform repetitive behaviors \r\n(compulsions) to relieve anxiety associated with \r\nobsessive thoughts or to prevent something \r\nbad from happening. ");
		txtrExplain.setBounds(23, 116, 404, 130);
		txtrExplain.setEditable(false);
		panel_1.add(txtrExplain);
		
		JLabel lblImage = new JLabel(new ImageIcon(getClass().getResource("/images/ocd.png")));
		...
		btnTreatment.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				treatments.ocdTreatments frame = new treatments.ocdTreatments();

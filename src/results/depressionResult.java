...
public class depressionResult extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					depressionResult frame = new depressionResult();
	 ...
	 * Create the frame.
	 */
	public depressionResult() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setTitle("Psychological Disorders Diagnosis Expert System");
		setIconImage(Toolkit.getDefaultToolkit().getImage(depressionResult.class.getResource("/images/icon.png")));
		...
		txtrExplain.setText("Depression affects how people feel, think, and \r\nbehave, and in severe cases, life may feel worthless.");
		txtrExplain.setBounds(23, 129, 409, 105);
		txtrExplain.setEditable(false);
		panel_1.add(txtrExplain);
		
		JLabel lblImage = new JLabel(new ImageIcon(getClass().getResource("/images/depression.png")));
		...
		btnTreatment.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				treatments.depressionTreatments frame = new treatments.depressionTreatments();

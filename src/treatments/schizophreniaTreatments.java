...
public class schizophreniaTreatments extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					schizophreniaTreatments frame = new schizophreniaTreatments();
	...
	public schizophreniaTreatments() {
		...
		lbl_anxT2.setBounds(27, 137, 143, 27);
		panel_1.add(lbl_anxT2);
		
		JLabel lbl_anxT3 = new JLabel("Psychosocial interventions");
		...
		textrT1.setText("Psychotherapy methods like cognitive behavioral therapy can help people with schizophrenia cope with and \r\nmanage their condition. Long-term therapy can also help with secondary problems alongside schizophrenia, \r\nsuch as anxiety, depression or substance use issues.");
		textrT1.setBounds(27, 48, 807, 66);
		textrT1.setEditable(false);
		panel_1.add(textrT1);
		
		JTextArea textrT2 = new JTextArea();
		textrT2.setBackground(new Color(255, 240, 245));
		textrT2.setText("Medications are the cornerstone of schizophrenia treatment, and antipsychotic medications are the most commonly \r\nprescribed drugs. They're thought to control symptoms by affecting the brain neurotransmitter dopamine.");
		...
		textrT3.setText("Once psychosis recedes, in addition to continuing on medication, psychological interventions are important. \r\nThese may include Individual therapy, Social skills training, Family therapy, and Vocational rehabilitation.");
		...
		btnReport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				reports.schizophreniaReport frame = new reports.schizophreniaReport();

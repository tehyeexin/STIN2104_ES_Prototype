...
public class depressionTreatments extends JFrame {
	...
	public depressionTreatments() {
		...
		JLabel lblInfo = new JLabel("Here is the treatments for Depression that are suggested for you.");
		...
		JLabel lbl_depT3 = new JLabel("Electroconvulsive therapy (ECT)");
		...
		JLabel lbl_depT4 = new JLabel("Transcranial magnetic stimulation (TMS)");
		...
		JLabel lbl_depT5 = new JLabel("Complementary therapy");
		lbl_depT5.setForeground(new Color(160, 82, 45));
		lbl_depT5.setFont(new Font("Dubai", Font.PLAIN, 20));
		lbl_depT5.setBounds(70, 241, 207, 20);
		panel_1.add(lbl_depT5);
